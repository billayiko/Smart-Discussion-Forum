    ...
    <div class="pulse-page">
        <div class="pulse-app">
            ...
            <main class="pulse-main">
                @include('pages.dashboards.questions._header', ['title' => 'Question', 'subtitle' => 'Review this question and its replies.'])
                @include('pages.dashboards.questions._thread', ['canReply' => false, 'canComplain' => false, 'canDelete' => true])
            </main>
        </div>
    </div>
